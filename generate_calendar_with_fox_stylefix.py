...
fox = load_json("fox_films.json")

all_films = revue + paradise + tiff + fox
...
.toggle.fox { background-color: #f59e0b; }
...
.fox .time { background-color: #f59e0b; }
...
<div class='filters'>
  ...
  <div class='toggle-filters'>
    ...
    <button class='toggle fox active' data-source='Fox Theatre'>FOX</button>
...
html.append("""
<script>
const activeSources = new Set(["Revue Cinema", "Paradise Theatre", "TIFF Bell Lightbox", "Fox Theatre"]);
